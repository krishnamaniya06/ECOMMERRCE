...
const AllProducts = () => {
  ...
  // Fetch products and initial wishlist
  useEffect(() => {
  ...
  if (products.length === 0) return <div className="container mx-auto mt-32 text-center">No products found.</div>;
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="container mx-auto px-4 mt-40">
        <h1 className="text-3xl font-bold mb-8 text-center">All Jewellery Collection</h1>
